/* ══════════════════════════════════════════════════════════════════════
   ...
   One component, used by both of this app's sign-in screens — the root
   page (index.html) and auth.html. They used to be two separate designs,
   which is how the root kept its old dark card while every 555 change
   landed on the page almost nobody opens.
...
export default function BookCover({ house = 'MJM Nursery', portal, children }) {
  return (
    <div className="bk-page">
      ...
      <style>{`
        /* Caveat and DM Sans are linked from the page head — index.html and
        ...
        .bk-logo{
          ...
          /* Lines the FACE of the middle 5 up with the cover's centre — the
             glyph the eye reads, not the ink of all three plus the extrusion
             that hangs down-right and drags the block with it.

             Two things push it right and they scale differently: glyph
             geometry and this element's own rotation go with font-size (the
